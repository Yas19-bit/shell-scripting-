...
main() {
    ...
    KEY_NAME="new-key-now"
    SUBNET_ID="subnet-0a85b691b4a205b9b"
    SECURITY_GROUP_IDS="sg-03a8f87d0a4eefeeb"  # Add your security group IDs separated by space
